module.exports.config = {
	...
	hasPermssion: 2,
	credits: "DEVIL",
	description: "THIS BOT IS MR DEVIL BABU",
  ...
  switch (type) {
        case "pending": {
          switch (body) {
   			...
   			api.sendMessage(`𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐃𝐞𝐯𝐢𝐥 𝐁𝐨𝐭 😇👈
=𝐎𝐰𝐧𝐞𝐫 ➻    🌹 𝐃𝐄𝐕𝐈𝐋 🌹●============================================================● 𝐀𝐩𝐏 𝐊𝐚 𝐆𝐫𝐎𝐮𝐏 𝐀𝐩𝐏𝐑𝐨𝐕𝐚𝐋 𝐊𝐚𝐑 𝐃𝐢𝐘𝐚 𝐇𝐚𝐈 =𝐎𝐰𝐧𝐞𝐫 ➻    🌹 ⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭ 🌹\n${idBox}`, threadID, () => {
...
module.exports.run = async ({ event, api, args, Threads, handleReply, Users }) => {
  ...
  const cre = this.config.credits
      ...
      api.sendMessage(`[ OK ] Your group has been removed from the browsing list by the admin for the reason: ${lydo}`, idBox);
   	...
   	else api.sendMessage("𝐖𝐞𝐥𝐜𝐨𝐦𝐞 𝐓𝐨 𝐀𝐚𝐝𝐢 𝐛𝐚𝐛𝐮 𝐁𝐨𝐭 😇●============================================================● 𝐀𝐩𝐏 𝐊𝐚 𝐆𝐫𝐎𝐮𝐏 𝐀𝐩𝐏𝐑𝐨𝐕𝐚𝐋 𝐊𝐚𝐑 𝐃𝐢𝐘𝐚 𝐇𝐚𝐈 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 ⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭ 🌹 \n✧●============================================================●\n●====== 𝐀𝐁𝐁  𝐊𝐀𝐑𝐎  𝐌𝐄𝐒𝐓𝐈 =====●\n●============================================================●\n=𝐎𝐰𝐧𝐞𝐫 ➻    🌹 ⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭ 🌹\n●============================================================●\n𝐀𝐩𝐏𝐤𝐀 𝐏𝐲𝐑𝐚 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 ⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭ 🌹 \n●============================================================●\n𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 𝐥𝐢𝐧𝐤 😊👈 𝐀𝐚𝐝𝐢 𝐛𝐚𝐛𝐮 :- ☞ \n\https://www.facebook.com/profile.php?id=61570398352958\n●============================================================●\n𝐊𝐢𝐒𝐢 𝐁𝐡𝐈 𝐓𝐚𝐇𝐚𝐑𝐚 𝐊𝐢 𝐇𝐞𝐋𝐩 𝐋𝐚𝐍𝐢 𝐇𝐨 𝐀𝐛𝐇𝐢 𝐌𝐞𝐒𝐒𝐠 𝐊𝐚𝐑𝐞 𝐎𝐰𝐧𝐞𝐫 ➻    🌹 ⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭ 🌹●============================================================● 👉 [+91 95011XXXX8]", idBox, (error, info) => {
   		api.changeNickname(` 〖 ${global.config.PREFIX} 〗 ➺ ${(!global.config.BOTNAME) ? "" : global.config.BOTNAME}`, idBox, global.data.botID);
      const axios = require('axios');
	const request = require('request');
	const fs = require("fs");
   let admID = "61570398352958";    
