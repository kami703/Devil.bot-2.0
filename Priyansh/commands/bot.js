...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "kamina") || (event.body.toLowerCase() == "sala")) {
       return api.sendMessage("Gali na de Devil ko bata dunga🙄🙄🙏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😱")) {
       return api.sendMessage("is nazar se serf  BACHIYA dekh sak thi hai Mujhe💞", threadID);
     };
    if ((event.body.toLowerCase() == "i hate you") || (event.body.toLowerCase() == "hate you")) {
       return api.sendMessage("Kya itna bura hoon main Ke AP Mujhe I hate you bol rahe ho ja main tujh se bat Nahi Kar ta😪😪😥😢", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "#uns") || (event.body.toLowerCase() == "#unsand")) {
       ...
       return api.sendMessage("️Is Bar Kar Rha Agli Bar Delete Nhi Kru Ga Bata Rha hu 🙄", threadID, messageID);
     };
    ...
    if ((event.body.toLowerCase() == "Kami") || (event.body.toLowerCase() == "Devil")) {
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "ashii") || (event.body.toLowerCase() == "ayehsa")) {
       ...
       if ((event.body.toLowerCase() == "Kon hai tu") || (event.body.toLowerCase() == "Ap kon ho")) {
     ...
     if ((event.body.toLowerCase() == "inbox aa")) {return api.sendMessage("kab Sai Hoga ye system Har koi inbox 📥 Jana chata 😀🙄🙄 ", threadID);
      ...
      if ((event.body.toLowerCase() == "ladki ho")) {return api.sendMessage("Nahi ye both Hai tharki insan 😂😀🙄 ", threadID);
              ...
              if ((event.body.toLowerCase() == "wow")) {return api.sendMessage("Thank you Apko bhi bot chahiya tOo Devil Boss se rabta karo👍👍💕" , threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "meri setting kahan hai") || (event.body.toLowerCase() == "meri gf kaha hai")) {     return api.sendMessage("️️️mujhy nahi pata me Shaan ki setting hu", threadID);
     ...
     if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "bot ka malik")) {
       return api.sendMessage("༻𝐎𝐖𝐍𝐄𝐑:- ☞ ༻☞[𝐎𝐖𝐍𝐄𝐑:☞➸⃝🐼⟬ 𝐆A͜͡𝐍𝐆𝐒𝐓E͜͡𝐑 ⟭⸙⟬ دیـﹻ۬ﹻۧ۬ﹻٰ۬ﹻٰ۬ﹻۧ۬ﹻ۬ﹻـول ⟭🎸  ☜ 𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 𝙆𝘼𝙈𝙄. ☜ ༺༒ ༒𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝༒:- https://www.facebook.com/𝙈𝙍.𝘿𝙀𝙑𝙄𝙇 345☞    his insta id @𝙉𝙄 𝙔𝘼𝘼𝘿 ☜ ༺༒ ༒", threadID);
     };

     if ((event.body.toLowerCase() == "tera Malik kon hai") || (event.body.toLowerCase() == "is bot ka malik kon hai")) {
       return api.sendMessage("DEVIL 𝐔𝐫𝐟 KAMI   ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Latkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
     };

    if ((event.body.toLowerCase() == "tera admin kon hai") || (event.body.toLowerCase() == "bot ka admin kon hai")) {
       return api.sendMessage("My admin is DEVIL. He Gives his name mr DEVIL everywhare", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "bts") || (event.body.toLowerCase() == "btc")) {
       return api.sendMessage("Tu H Bts matlab khusra. Bhos DK", threadID);
     };
    ...
    if ((event.body.toLowerCase() == "🙄")) {return api.sendMessage(" Devil Boss busy hai mujse bat karo🙄🙄 ", threadID);
     };
